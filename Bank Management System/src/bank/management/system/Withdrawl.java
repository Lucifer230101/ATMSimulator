...
//the Date class is inside this package
import java.util.*;
        ...
        if(ae.getSource() == withdraw){
            ...
            if(number.equals("")){
                ...
                try{
                    ...
                    if(balance < Integer.parseInt(number) || balance < 0){
                        JOptionPane.showMessageDialog(null, "Insufficient Balance");
                        return;
                    }
                    else{
                        String query = "insert into bank values('"+pinnumber+"', '"+date+"', 'Withdrawl', '"+number+"')";
                        //here query will throw an error saying needs to be caught if we dont use try and catch 
